...
export default function ProductCard (props) {
    ...
    return(
        ...
        <div className={props.colorL + " w-[70px] h-[70px] absolute top-0 right-20 md:right-2 rounded-xl flex flex-col justify-center items-center gap-2 shadow-xl cursor-pointer hover:scale-110"}>
